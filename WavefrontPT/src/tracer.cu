...
extern  "C" void cuda_SendRays(void* surface, size_t width, size_t height, size_t pitch)
{
    ...
    cuda_TraceRay <<<numberOfBlocksDim, threadsPBlockDim >>> ((unsigned char*)surface, width, height, pitch);
