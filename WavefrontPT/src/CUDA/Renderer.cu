...
void Renderer::InitializeRays(void* surface, size_t width, size_t height, size_t pitch) {
    cudaError_t error = cudaSuccess;

    cuda_InitTraceRay <<<gridSize, blockSize >>> ((unsigned char*)surface, width, height, pitch);
